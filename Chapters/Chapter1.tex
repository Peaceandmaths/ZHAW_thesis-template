...
\section{Neurology Propedeutics}

The main purpose of the introduction is to provide the rationale for the paper. The text moves from a general description of the topic (a very focused review, app. 1 paragraph) to research results relevant to the study and the particular question or hypothesis being investigated. The introduction also positions the author(s) in the research field.
