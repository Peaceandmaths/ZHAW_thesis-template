...
\thesistitle{Comparative Evaluation of Deep Neural Networks for Intracranial Aneurysm Segmentation }             % Thesis title,              command: \ttitle
\thesistype{Master Thesis}             % Type of thesis (e.g. Master Thesis) \ttype
\thesisdate{\today}                     % Date of submission                  \tdate
\keywords{deep learning, computer vision, neuroimaging, aneurysm segmentation}
                                        % Keywords for the thesis,            \keywordnames
\author{Ekaterina Golubeva}                  % Your name,                          \authorname
...
\supervisorA{Dr. Stefan Glüge}       % Name of supervisor 1,               \supnameA
\supervisorAmail{glue@zhaw.ch}         % Email address of supervisor 1,      \supmailA
...
\supervisorB{Prof. Dr. Thomas Ott}              % Name of supervisor 2,               \supnameB
\supervisorBmail{ottt@zhaw.ch}       % Email address of supervisor 2,      \supmailB
...
\supervisorC{Dr. Norman Juchler}       % Name of supervisor 3,               \supnameC
\supervisorCmail{juch@zhaw.ch}         % Email address of supervisor 3,      \supmailC
\supervisorCinfo{                       % Formatted info about supervisor 3:  \supinfoC
    \supnameC\\
    Zurich University of Applied Sciences\\
